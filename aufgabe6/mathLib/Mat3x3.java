...
public class Mat3x3 {
   ...
   /**
     ...
     **/
    final public Mat3x3 mul(final Mat3x3 l){
        if(l == null){
     ...
     * @throws IllegalArgumentException Get thrown if the parameter is null.
     **/
    final public Vector3 mul(final Vector3 v){
        if(v == null){
     ...
     * @throws IllegalArgumentException Get thrown if the parameter is null
     **/
    final public Mat3x3 changeCol1(final Vector3 v){
        if(v == null){
            throw new IllegalArgumentException("v must not be null");
        }
     ...
     * @throws IllegalArgumentException Get thrown if the parameter is null.
     **/
    final public Mat3x3 changeCol2(final Vector3 v){
        if(v == null){
            throw new IllegalArgumentException("v must not be null");
        }
     ...
     * @throws IllegalArgumentException Get thrown if the parameter is null.
     **/
    final public Mat3x3 changeCol3(final Vector3 v){
        if(v == null){
            throw new IllegalArgumentException("v must not be null");
        }
